# Navegação PNCP em Números

Documentação narrativa e metodológica para o painel **PNCP em Números** — webinar 2026, nova versão.

Este repositório consolida a narração estruturada por capítulos, descrevendo como ler as contratações públicas divulgadas no PNCP (Portal Nacional de Contratações Públicas), os filtros aplicáveis em cada etapa do processo administrativo e as regras de contabilização adotadas no painel.
...
Documento preliminar em construção. Próximo bloco: indicadores executivos do painel.

## Base normativa

- Lei nº 14.133/2021 — Arts. 54, 94 e 174.
- Manual de Integração do PNCP — seção 5.5 (Situação da Contratação).
